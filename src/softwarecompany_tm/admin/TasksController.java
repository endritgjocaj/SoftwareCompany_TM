...
public class TasksController implements Initializable {
    ...
    public void getProjectsAndEmployees(){
        for(Projects project : projectsList){
            if(get(actualDate) < get(project.getDueDate())){
                projectChoiceBox.getItems().addAll(project);
            }
        }
        ...
        projectChoiceBox.getSelectionModel().selectedItemProperty().addListener((ObservableValue<? extends Projects> observable, Projects oldValue, Projects newValue) -> {
            setEmployeeToTask(newValue);
        }
        );
    }
    
    public void setEmployeeToTask(Projects slcProject){
    ...
    private void addTask(ActionEvent event) {
        ...
        List<Technologies> tekList = new ArrayList<>();
